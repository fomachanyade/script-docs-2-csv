...
describe("parse_docs_test", () => {
    describe("章が一つの場合", ()=>{
        ...
        it("章の配列が正しい", ()=>{
            ...
            const resultChapterTiles = result.chapters.map((chapter) => chapter.title)
        ...
        it("章の内容が正しい", ()=>{
            ...
            expect(result.chapters[0].content).toEqual([["主人公", "だれだ"], ["敵", "私だ"],["主人公", "お前だったのか"]])
        })
    });
    ...
    describe("章が複数の場合", ()=>{
        ...
        it("章の内容が正しい", ()=>{
            ...
            expect(result.chapters[2].content).toEqual([["主人公", "お前だったのか"]])
        })
